...
public class CruiseShip
{
    ...
    static void OptionMatch(String[] cruiseShips)
    {
        ...
        switch (letter) {
            case "A" : AddingCustomersToCruiseShips(cruiseShips);break;
            case "V" : ViewAllCabins(cruiseShips);break;
            case "E" : DisplayEmptyCabins(cruiseShips);break;
            case "D" : DeleteCustomerFromCabin(cruiseShips);break;
            case "F" : FindCabinFromCustomerName(cruiseShips);break;
            case "S" : StoreProgramData(cruiseShips);break;
            case "L" : LoadProgramData(cruiseShips);break;
            case "O" : ViewPassengersOrderedAlphabeticallyByName(cruiseShips);break;
            default : {
                System.out.println("\nInvalid Option....\nTry Again");
